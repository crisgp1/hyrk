export const en = {
  ...
  navbar: {
    ...
    email: 'Email',
    phone: 'Phone',
    servicesDescription: 'Our expertise & solutions',
    clientsDescription: 'Success stories & partnerships',
    aboutDescription: 'Our story & mission',
    contactDescription: 'Get in touch with us',
    ourServices: 'Our Services',
    
    // Services
    softwareConsultancy: 'Software Consultancy',
    softwareConsultancyDesc: 'Strategic guidance for your tech decisions',
    softwareDevelopment: 'Software Development',
    softwareDevelopmentDesc: 'Custom solutions built to your specifications',
    cloudProducts: 'Cloud Products',
    cloudProductsDesc: 'Scalable cloud-native applications',
    ecommerceSolutions: 'E-commerce Solutions',
    ecommerceSolutionsDesc: 'Complete online store platforms',
    processDigitalization: 'Process Digitalization',
    processDigitalizationDesc: 'Transform manual workflows into digital systems',
  },
  ...
  home: {
    ...
    subtitle6: 'advanced client tracking',
    subtitle7: 'systems',
